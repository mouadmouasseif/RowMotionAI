  ...
  return (
    <footer className="site-footer">
      <div className="footer-top">
        ...
        <div className="footer-credit"><span>Développé par</span><Link href="https://mouadmouasseif.vercel.app/"><Image src="/made-for-web.png" alt="Mouad Mouasseif" width={42} height={42} /><strong>Mouad Mouasseif</strong></Link></div>
      </div>
