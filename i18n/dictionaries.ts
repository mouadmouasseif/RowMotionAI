...
export const dictionaries = {
  fr: {
    ...
    common: { discover: "Découvrir la plateforme", startAnalysis: "Commencer une analyse", learnMore: "En savoir plus", contact: "Demander une démonstration", noResults: "Aucun résultat public trouvé.", install: "Installer RowMotion AI", search: "Recherche" },
  ...
  en: {
    ...
    common: { discover: "Discover the platform", startAnalysis: "Start an analysis", learnMore: "Learn more", contact: "Request a demo", noResults: "No public result found.", install: "Install RowMotion AI", search: "Search" },
  ...
  ar: {
    ...
    common: { discover: "اكتشف المنصة", startAnalysis: "ابدأ التحليل", learnMore: "اعرف المزيد", contact: "اطلب عرضاً توضيحياً", noResults: "لم يتم العثور على نتائج عامة.", install: "ثبّت RowMotion AI", search: "بحث" },
