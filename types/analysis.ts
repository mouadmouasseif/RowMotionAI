...
export type AnalysisStatus = "draft" | "uploading" | "uploaded" | "preparing" | "queued" | "processing" | "analyzing" | "generating_results" | "completed" | "failed" | "cancelled";
export type AnalysisStep = "validation" | "upload" | "video_preparation" | "video_preprocessing" | "athlete_detection" | "pose_detection" | "stroke_detection" | "biomechanics" | "metrics_calculation" | "recommendations" | "report_generation" | "saving_results" | "completed";
