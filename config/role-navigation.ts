...
export const navigationByRole: Record<UserRole, RoleNavigationSection[]> = {
  ...
  TECHNICAL_DIRECTOR: [
    ...
    { label: "Athletes", items: [{ label: "Tous les athletes", href: "/athletes", icon: Users }, { label: "Groupes", href: "/athletes", icon: Users }, { label: "Talents", href: "/technical-director/dashboard", icon: Medal }, { label: "Athletes a surveiller", href: "/technical-director/dashboard", icon: HeartPulse }, { label: "Comparaisons", href: "/analyses", icon: BarChart3 }] },
