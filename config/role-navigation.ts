...
export const navigationByRole: Record<UserRole, RoleNavigationSection[]> = {
  ...
  SUPER_ADMIN: [
    ...
    { label: "Gestion globale", items: [{ label: "Athletes", href: "/super-admin/athletes", icon: Users }, { label: "Coaches", href: "/super-admin/coachs", icon: UserCog }, { label: "Directeurs techniques", href: "/technical-director/dashboard", icon: ShieldCheck }, { label: "Clubs", href: "/super-admin/clubs", icon: Building2 }, { label: "Competitions", href: "/competitions", icon: Trophy }, { label: "Jury / Jurees", href: "/jury/dashboard", icon: ShieldCheck }, { label: "Plans d'entrainement", href: "/plans-entrainement", icon: BookOpen }] },
